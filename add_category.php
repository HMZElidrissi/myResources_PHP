                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="">
                            <div class="form-group row">
                                <label for="addCategoryTitle" class="col-sm-3 col-form-label">Titre:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="addCategoryTitle" name="addCategoryTitle" placeholder="Titre du nouvelle catégorie ...">
                                </div>
                            </div>
